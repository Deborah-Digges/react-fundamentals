...
- JSX is syntactic sugar for the `React.createElement` API
- Therefore, we need to have React in scope whenever we are using JSX
- JSX cannot be rendered in the browser directly. It needs to be converted into
  Javascript using babel. This is usually done at build time
