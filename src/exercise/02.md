...
- There are 2 react libraries we work with: React and React DOM
- React: responsible for creating React elements
- ReactDOM: responsible for rendering react elements to the DOM
- React.createElement(elementType, elementProperties) // elementProperties - id,
  children
- ReactDOM.render(reactElement, domRoot)
